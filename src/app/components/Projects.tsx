...
const Projects = () => {
  const projects = [
    ...
    {
      id: 2,
      title: 'Fullstack Todo App with Chatbot',
      description: 'A fullstack todo application with an integrated AI chatbot for smart task management.',
      technologies: ['Next.js', 'TypeScript', 'Fullstack'],
      image: '/image/project2.svg',
      liveUrl: 'https://fullstack-todo-app-6j7s.vercel.app/',
      githubUrl: 'https://github.com/asadali7755/Phase-3-fullstack-todo-app-chatbot',
    },
    {
      id: 3,
      title: 'E-Commerce Business Website',
      description: 'A modern e-commerce business website with product listings, shopping cart, and seamless checkout experience.',
      technologies: ['Next.js', 'TypeScript', 'Tailwind CSS'],
      image: '/image/project3.svg',
      liveUrl: 'https://hackathon3-phi.vercel.app/',
      githubUrl: 'https://github.com/asadali7755/hackathon3',
    },
  ];
